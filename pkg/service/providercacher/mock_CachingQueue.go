...
func (_mock *MockCachingQueue) Read(ctx context.Context, maxJobs int) ([]queue.WithID[ProviderCachingJob], error) {
	...
	var r0 []queue.WithID[ProviderCachingJob]
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, int) ([]queue.WithID[ProviderCachingJob], error)); ok {
		return returnFunc(ctx, maxJobs)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, int) []queue.WithID[ProviderCachingJob]); ok {
		r0 = returnFunc(ctx, maxJobs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]queue.WithID[ProviderCachingJob])
		}
	}
...
func (_c *MockCachingQueue_Read_Call) Return(withIDs []queue.WithID[ProviderCachingJob], err error) *MockCachingQueue_Read_Call {
	_c.Call.Return(withIDs, err)
	return _c
}

func (_c *MockCachingQueue_Read_Call) RunAndReturn(run func(ctx context.Context, maxJobs int) ([]queue.WithID[ProviderCachingJob], error)) *MockCachingQueue_Read_Call {
	_c.Call.Return(run)
	return _c
}
